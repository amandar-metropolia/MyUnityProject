...
public class Projectile : MonoBehaviour
{
    ...
    void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            ParticleSystem hitParticlesInstance = Instantiate(_hitParticles, transform.position, Quaternion.identity);
            Destroy(hitParticlesInstance.gameObject, hitParticlesInstance.main.duration);
            DestroyProjectile();
        }
